...
welcome_audio_file = "welcome.wav"  # Replace with your actual welcome audio file name
if os.path.exists(os.path.join(audio_dir, welcome_audio_file)):
    ...
    print("Welcome audio file not found. Proceeding without it.")

# Ask the user for the playback speed
try:
    speed = float(input("I kpaa mo pɛɛ nɛ̃ o ngmã bɔnɛ̃ mã tsɛ́ aloo kané nɔ̃ hã mo hã( ké o ngmã 1.0 ɔ í mã tsɛ́ aloo kané nɔ̃ ɔ̃ blɛuu, ké o ngmã 1.5 ɔ í mã tsɛ́ aloo kané nɔ̃ ɔ̃ kɛ oyá bɔɔ, sé ké o ngmã 1.0 ɔ í mã tsɛ́ aloo kané nɔ̃ ɔ̃ oyá ): "))
except ValueError:
